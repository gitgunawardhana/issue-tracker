...
export const SearchIcon = ({ className = base }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.2-5.2M16.5 10.5a6 6 0 1 1-12 0 6 6 0 0 1 12 0Z" />
  </svg>
);
...
export const UserPlusIcon = ({ className = base }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
...
export const UserMinusIcon = ({ className = base }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
...
export const BugIcon = ({ className = base }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v4m0 8v2m-4-6H6m12 0h-2m-8.5 0a4.5 4.5 0 1 0 9 0 4.5 4.5 0 0 0-9 0Zm0 0V8a3.5 3.5 0 1 1 7 0v4m-7 0H6.5m11 0H17M7 16l-2 2m12 0-2-2M7 8l-2-2m12 0-2 2" />
  </svg>
);

export const CircleOpenIcon = ({ className = base }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
